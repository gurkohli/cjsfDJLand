...
if(isset($_POST['ad_list']) ){
	...
	if($type=='id'){
		echo "<option value='You are listening to CJSF Radio 90.1 FM, broadcasting from unceded Coast Salish territory in Burnaby, BC'>You are listening to CJSF 90.1 FM, broadcasting from unceded Coast Salish territory in Burnaby, BC</option>";
