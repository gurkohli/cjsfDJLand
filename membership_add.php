...
<div style="display:none;">
			<div id='row3 'class='containerrow'>
					...
					<div class='col5'><input id='address' class='' placeholder='Address' maxlength='50'></input></div>
					<div class='col5'>City*:</div>
					<div class='col5'><input id='city' class='' placeholder='City' maxlength='45'></input></div>
				</div>
				<div id='row4 'class='containerrow'>
					...
					<div class='col5'><input id='postalcode' class='' placeholder='Postal Code' maxlength='6'></input></div>
				</div>
</div>
<div style="display:none">
...
<div style="display:none;">
				...
				<div class='containerrow'>
					<div class='col5'>Do you have a show? Check this box if yes*:</div>
