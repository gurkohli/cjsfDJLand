...
<html>
	...
	<body class='wallpaper'>
		...
		<div class='membership grey clearfix'>
			<h1 id="title"> CJSF Member Settings </h1>
            <h4 id="subtitle"></h4>
...
<div style='display:none'>
				<div id='row3 'class='containerrow'>
					...
					<div class='col5'><input id='address' class='req' placeholder='Address' maxlength='50'/></div>
					<div class='col5'>City*:</div>
					<div class='col5'><input id='city' class='req' placeholder='City' maxlength='45'/></div>
				</div>
				<div id='row4 'class='containerrow'>
					...
					<div class='col5'><input id='postalcode' class='req' placeholder='Postal Code' maxlength='6'/></div>
				</div>
</div>
...
<div style='display:none'>
				...
				<div class='containerrow student'>
					...
					<div class='span3col5'>I would like to incorporate CJSF into my courses(projects,practicums,etc.):
				...
				<div id='row8' class='containerrow'>
					...
					<div class='col6'><input id='email' class='req'  name='email' placeholder='Email Address' maxlength='40'></input><div id='email_check' class='green text-center invisible'></div></div>
					<div class='col6'>Primary Number*:</div>
					<div class='col6'><input id='primary_phone' class='req' name='phone1' placeholder='Phone Number' maxlength='10' onKeyPress="return numbersonly(this, event)"/></div>
