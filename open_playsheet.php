<html ng-app='openPlaysheet'>
	...
	<body class='wallpaper' ng-controller='openPlaysheetController as open_playsheet'>
		...
		<div id="wrapper">
		<div class='filter-shows text-center'>Filter by show name
		...
		<div ng-hide="open_playsheet.playsheets || open_playsheet.loading == true" class='text-center'>You have no shows assigned to this account. Please ask a staff member 
to assign you to your show</div>
		<div ng-show="open_playsheet.playsheets">
