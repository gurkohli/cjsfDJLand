...
<div style="display:none">
				<div id='row3 'class='containerrow'>
					...
					<div class='col5'><input id='address' class='' placeholder='Address' maxlength='50'/></div>
					<div class='col5'>City*:</div>
					<div class='col5'><input id='city' class='' placeholder='City' maxlength='45'/></div>
				</div>
				<div id='row4 'class='containerrow'>
					...
					<div class='col5'><input id='postalcode' class='' placeholder='Postal Code' maxlength='6'/></div>
				</div>
</div>
				<div class='containerrow'>
					<div class='col5'>SFU Alumni:</div>
...
-->
				...
				<div class='containerrow student'>
					...
					<div class='span3col5'>
						I would like to incorporate CJSF into my courses(projects,practicums,etc.): <input id='integrate'  name='integrate' type='checkbox' />
					</div>
				</div>
				<div class='containerrow'>
		...
		<div id='report' class='hidden membership grey clearfix'>
			...
			<div class='col1 text-center'>
   			...
   			<div id="membership_result" class='overflow_auto height_cap'>
   				<div class='col2'>
	   				<h4>DJs Registered this year</h4>
	   				<ul class='clean-list'>
