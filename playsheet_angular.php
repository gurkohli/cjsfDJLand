	...
	<body class='wallpaper' ng-controller="PlaysheetController as playsheet">
		...
		<div ng-show="playsheet.member_shows" id='wrapper' ng-class="{socan: playsheet.socan }">
			 <div class='col1 side-padded'>
		      	<div class='col2 padded'>
					...
					<div class='col1 double-padded-top'>
						...
						<option value="Prerecord">Pre-record</option>
					...
					<h4 style="visibility:hidden" class='text-left'>Show Data</h4>
			...
			<div class='col1 side-padded double-padded-top'>
					<h4>Episode Title</h4>
					<input class='wideinput' ng-change='playsheet.checkIfComplete()' ng-model = 'playsheet.info.title'/>
					<h4>Episode Description</h4>
					<textarea class='fill' ng-change='playsheet.checkIfComplete()' ng-model='playsheet.info.summary'></textarea>
			</div>
			...
			<div class="tracklist_overlay" ng-show="playsheet.tracklist_overlay">
				<button ng-click='playsheet.tracklist_overlay = !playsheet.tracklist_overlay'><img src="./Cancel.png"></button>
				...
				<div class='text-center'>Podcasts can be found <a href="http://djland.cjsf.ca/podcasts.php?id={{playsheet.podcast.show_id}}">here.</a></div>
